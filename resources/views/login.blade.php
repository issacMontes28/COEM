...
<body>
  <div class="wrapper">
    {!!Form::open(['class'=>'login','route'=>'log.store', 'method'=>'POST'])!!}
       <p class="title">Sistema de Clínica COEM</p>
        ...
        <footer><a target="blank" href="http://boudra.me/">Issac Montes, Ingeniero en informática (UPEMOR)</a></footer>
    {!!Form::close()!!}
  </div>
